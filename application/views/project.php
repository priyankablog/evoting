...
<!-- Mirrored from html.tonatheme.com/2017/Corpro_template/project.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:23:43 GMT -->
<head>
<meta charset="utf-8">
...
<div class="page-wrapper">
    ...
    <section class="page-title" style="background-image: url(images/background/4.jpg);">
    	<div class="auto-container">
        	<h1>Project Default</h1>
        	<ul class="bread-crumb">
                <li><a href="index-2.html">Home</a></li>
                <li><a href="#">Projects</a></li>
                <li class="active">Project Default</li>
            </ul>
        </div>
    </section>
    <!--End Page Title-->
