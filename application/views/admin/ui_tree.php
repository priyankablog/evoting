...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/ui_tree.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:25:58 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8"/>
    <title>PVR Admin | Tree View</title>
            ...
            <ul class="nav">
                ...
                <li class="has-sub active">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="active"><a href="ui_tree.html">Tree View</a></li>
                            ...
                            <ul>
                                <li data-jstree='{"opened":true}'>
                                    ...
                                    <ul>
                                        ...
                                        <li data-jstree='{ "icon" : "fa fa-warning fa-lg text-danger" }'>custom icon
                                            class (fontawesome)
                                        </li>
                                        <li data-jstree='{ "icon" : "fa fa-link fa-lg text-primary" }'><a
                                                href="http://www.jstree.com/">Clickable link node</a></li>
                                    </ul>
                                </li>
                                <li>Root node 2</li>
                            </ul>
            ...
            <div class="col-md-6">
                <div class="panel panel-inverse" data-sortable-id="tree-view-3">
                    ...
                    <div class="alert alert-info">
                        <i class="fa fa-info-circle fa-fw"></i> All the opened & selected nodes will be saved in the
                        user's browser.
                    </div>
                    <div class="panel-body">
...
<script src="assets/js/ui_tree_demo.js"></script>
...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/ui_tree.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:26:23 GMT -->
</html>