...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/table_manage_keytable.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:30:40 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8"/>
    <title>PVR Admin | Managed Tables - KeyTable</title>
...
<div id="page-container" class="fade in page-sidebar-fixed page-header-fixed">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="has-sub active">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="active"><a href="table_manage_keytable.html">KeyTable</a></li>
    ...
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Managed Tables - KeyTable
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                ...
                <p class="m-b-20">
                    <a href="http://www.datatables.net/extensions/keytable/" target="_blank"
            ...
            <div class="col-md-10">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="alert alert-success fade in">
                        ...
                        KeyTable provides enhanced accessibility and navigation options for DataTables enhanced tables,
                        by allowing Excel like cell navigation on any table. Events (focus, blur, action etc) can be
                        assigned to individual cells, columns, rows or all cells to allow advanced interaction options.
                    </div>
...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/table_manage_keytable.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:30:41 GMT -->
</html>