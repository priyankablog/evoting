...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/map_google.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:31:13 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8"/>
    <title>PVR Admin | Maps</title>
...
<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
            ...
            <ul class="nav">
                ...
                <li class="has-sub active">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="active"><a href="map_google.html">Google Map</a></li>
                    </ul>
                </li>
                <li class="has-sub">
                    <a href="javascript:;">
    ...
    <div id="content" class="content content-full-width">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Google Map
...
<script src="assets/js/map_google_demo.js"></script>
