...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/form_editable.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:27:50 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8"/>
    <title>PVR Admin | Form X-Editable Page</title>
    ...
    <link href="assets/plugins/bootstrap3-editable/inputs-ext/bootstrap-datepicker/css/datepicker.css"
          rel="stylesheet"/>
    <link href="assets/plugins/bootstrap3-editable/inputs-ext/bootstrap-datepicker/css/datepicker3.css"
          rel="stylesheet"/>
    <link href="assets/plugins/bootstrap3-editable/inputs-ext/bootstrap-datetimepicker/css/datetimepicker.css"
          rel="stylesheet"/>
    <link href="assets/plugins/bootstrap3-editable/inputs-ext/select2/select2.css" rel="stylesheet"/>
    <link href="assets/plugins/bootstrap3-editable/inputs-ext/bootstrap-wysihtml5/src/bootstrap-wysihtml5.css"
          rel="stylesheet"/>
    <!-- ================== END PAGE CSS STYLE ================== -->
...
<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
            ...
            <ul class="nav">
                ...
                <li class="has-sub active">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="active"><a href="form_editable.html">X-Editable</a></li>
    ...
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">X-Editable
        ...
        <div class="panel panel-inverse">
            ...
            <div class="panel-body">
                <p>
                    ...
                    <a href="form_editable33663366.html?c=inline" class="btn btn-primary btn-xs" data-editable="inline">Inline</a>
                </p>
                <div class="table-responsive">
                    <table id="user" class="table table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <td><span
                                    class="text-muted">Select, loaded from server. <strong>No buttons</strong> mode </span>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><a href="#" id="vacation" data-type="date" data-viewformat="dd.mm.yyyy" data-pk="1"
                                   data-placement="right" data-title="When you want vacation to start?">25.02.2013</a>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="#" id="comments" data-type="textarea" data-pk="1"
                                   data-placeholder="Your comments here..." data-original-title="Enter comments">awesome<br/>user!</a>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div id="note" data-pk="1" data-type="wysihtml5" data-toggle="manual"
                                    ...
                                    <p><i>Source:</i><a href="http://en.wikipedia.org/wiki/WYSIWYG_(disambiguation)">wikipedia.org</a>
                                    </p>
                                </div>
                            </td>
                            <td>
...
<script src="assets/js/form_editable_demo.js"></script>
...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/form_editable.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:28:54 GMT -->
</html>