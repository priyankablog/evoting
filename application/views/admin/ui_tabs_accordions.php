...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/ui_tabs_accordions.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:24:50 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8"/>
    <title>PVR Admin | Tabs & Accordions</title>
...
<div id="page-container" class="fade page-header-fixed page-sidebar-fixed">
    ...
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Tabs & Accordions
                ...
                <div class="tab-content">
                    <div class="tab-pane fade active in" id="default-tab-1">
                        ...
                        <p>
                            ...
                            porttitor,
                            est diam sagittis orci, a ornare nisi quam elementum tortor. Proin interdum ante porta est
                            convallis
                            dapibus dictum in nibh. Aenean quis massa congue metus mollis fermentum eget et tellus.
                            Aenean tincidunt, mauris ut dignissim lacinia, nisi urna consectetur sapien, nec eleifend
                            orci eros id lectus.
                        </p>
                    ...
                    <div class="tab-pane fade" id="default-tab-3">
                        <p>
                            ...
                            Quisque et quam id felis tempus volutpat at at diam. Vivamus ac diam turpis.Sed at lacinia
                            augue.
                ...
                <ul class="nav nav-pills">
                    <li class="active">
                        <a href="#nav-pills-tab-1" data-toggle="tab">
                            ...
                            <span class="hidden-xs">Pills Tab 1</span>
                        </a>
                    </li>
                    <li>
                        <a href="#nav-pills-tab-2" data-toggle="tab">
                            <span class="visible-xs">Pills 2</span>
                            <span class="hidden-xs">Pills Tab 2</span>
                        </a>
                    </li>
                    <li>
