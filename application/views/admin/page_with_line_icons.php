...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/page_with_line_icons.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:31:58 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8"/>
    <title>PVR Admin | Page with Line Icons</title>
...
<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
        ...
        <div data-scrollbar="true" data-height="100%">
            ...
            <ul class="nav">
                ...
                <li class="has-sub">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li><a href="ui_modal_notification.html">Modal & Notification <i
                                class="icon-paper-plane text-theme m-l-5"></i></a></li>
                ...
                <li class="has-sub">
                    ...
                    <ul class="sub-menu">
                        <li><a href="form_elements.html">Form Elements <i class="icon-paper-plane text-theme"></i></a>
                        </li>
                        <li><a href="form_plugins.html">Form Plugins <i class="icon-paper-plane text-theme"></i></a>
                        </li>
                ...
                <li class="has-sub active">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="active"><a href="page_with_line_icons.html">Page with Line Icons</a></li>
    ...
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Page with Line Icons
            <small>header small text goes here...</small>
        </h1>
        <!-- end page-header -->

        <p>
            Sample sidebar created with <a href="ui_simple_line_icons.html">Simple Line Icons</a>
        </p>
    </div>
    <!-- end #content -->
...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/page_with_line_icons.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:31:59 GMT -->
</html>