...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/ui_typography.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:24:50 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8"/>
    <title>PVR Admin | Typography</title>
...
<div id="page-container" class="fade page-header-fixed page-sidebar-fixed">
            ...
            <ul class="nav">
                ...
                <li class="has-sub active">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="active"><a href="ui_typography.html">Typography</a></li>
    ...
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Typography
            ...
            <div class="col-md-6">
                ...
                <div class="panel panel-inverse" data-sortable-id="ui-typography-8">
                    ...
                    <div class="panel-body">
                        ...
                        <p>
                            ...
                            auctor fringilla. Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget
                ...
                <div class="panel panel-inverse" data-sortable-id="ui-typography-10">
                    ...
                    <div class="panel-body">
                        ...
                        <p><abbr title="HyperText Markup Language" class="initialism">HTML</abbr> is the best thing
