...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/table_manage_fixed_columns.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:30:36 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8"/>
    <title>PVR Admin | Managed Tables - Fixed Columns</title>
...
<div id="page-container" class="fade in page-sidebar-fixed page-header-fixed">
    ...
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Managed Tables - Fixed Columns
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                ...
                <p class="m-b-20">
                    <a href="http://www.datatables.net/extensions/fixedcolumns/" target="_blank"
            ...
            <div class="col-md-10">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="alert alert-danger fade in">
                        ...
                        When making use of DataTables' x-axis scrolling feature (scrollXDT), you may wish to fix the
                        left or right most columns in place.
                        This plug-in for DataTables provides exactly this option (for non-scrolling tables, please use
                        the FixedHeader plug-in, which can fix headers, footers and columns).
                    </div>
...
<script src="assets/js/table_manage_fixed_columns_demo.js"></script>
...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/table_manage_fixed_columns.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:30:38 GMT -->
</html>