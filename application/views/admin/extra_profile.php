...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/extra_profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:32:01 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8"/>
    <title>PVR Admin | Profile Page</title>
                        ...
                        <div class="table-responsive">
                            <table class="table table-profile">
                                ...
                                <tr>
                                    ...
                                    <td><i class="fa fa-mobile fa-lg m-r-5"></i> +1-(847)- 367-8924 <a href="#"
                                                                                                       class="m-l-5">Edit</a>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td class="col-md-1 p-r-5">
                                        <a href="javascript:;" class="pull-left">
                                            <img src="assets/img/product.png" width="40px" alt="">
                                        </a>
                                    </td>
                                    <td>
                            ...
                            <ul class="todolist">
                                <li class="active">
                                    <a href="javascript:;" class="todolist-container active" data-click="todolist">
                                        ...
                                        <div class="todolist-title">Donec vehicula pretium nisl, id lacinia nisl
                                            tincidunt id.
                                        </div>
                                    </a>
                                </li>
                                ...
                                <li>
                                    <a href="javascript:;" class="todolist-container" data-click="todolist">
                                        <div class="todolist-input"><i class="fa fa-square-o"></i></div>
                                        <div class="todolist-title">Phasellus bibendum, odio nec vestibulum
                                            ullamcorper.
                                        </div>
                                    </a>
                                </li>
...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/extra_profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:32:02 GMT -->
</html>