...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/email_inbox.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:24:31 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8"/>
    <title>PVR Admin | Inbox (10)</title>
        ...
        <div data-scrollbar="true" data-height="100%">
            ...
            <ul class="nav">
                ...
                <li class="has-sub active">
                    ...
                    <ul class="sub-menu">
                        <li class="active"><a href="email_inbox.html">Inbox v1</a></li>
                    ...
                    <form>
                        <div class="input-group m-b-15">
                            ...
                            <span class="input-group-btn">
                                <button class="btn btn-sm btn-inverse" type="button"><i
                ...
                <div class="col-md-10">
                    ...
                    <div class="email-content">
                        <table class="table table-email">
                            <thead>
                            <tr>
                                <th class="email-select"><a href="#" data-click="email-select-all"><i
                                        class="fa fa-square-o fa-fw"></i></a></th>
                                <th colspan="2">
                                    <div class="dropdown">
                                        <a href="#" class="email-header-link" data-toggle="dropdown">View All <i
                                ...
                                <th class="text-nowrap">
                                    <div class="dropdown">
                                        <a href="#" class="email-header-link" data-toggle="dropdown">Arrange by <i
                                                class="fa fa-angle-down m-l-5"></i></a>
                                        <ul class="dropdown-menu">
                            ...
                            <tr>
                                ...
                                <td class="email-subject">
                                    <a href="#" class="email-btn" data-click="email-archive"><i
                                            class="fa fa-folder-open"></i></a>
                                    <a href="#" class="email-btn" data-click="email-remove"><i
                                            class="fa fa-trash-o"></i></a>
                                    <a href="#" class="email-btn" data-click="email-highlight"><i
...
<!-- ================== BEGIN PAGE LEVEL JS ================== -->
<script src="assets/js/inbox_demo.js"></script>
...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/email_inbox.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:24:32 GMT -->
</html>
