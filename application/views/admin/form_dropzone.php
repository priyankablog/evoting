...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/form_dropzone.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:29:16 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8"/>
    <title>PVR Admin | Dropzone</title>
            ...
            <ul class="nav">
                ...
                <li class="has-sub active">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="active"><a href="form_dropzone.html">Dropzone</a></li>
                    </ul>
                </li>
                <li class="has-sub">
                    <a href="javascript:;">
    ...
    <div id="content" class="content">
        ...
        <div class="row">
            ...
            <div class="col-md-2 m-b-15">
                <p class="m-b-15 text-inverse"><b>DropzoneJS</b> is an open source library that provides drag’n’drop
                ...
                <a href="http://www.dropzonejs.com/" target="_blank" class="btn btn-inverse btn-sm">View Official
                    Website</a>
            </div>
            <!-- end col-2 -->
            <!-- begin col-10 -->
            <div class="col-md-10">
                ...
                <div class="panel panel-inverse" data-sortable-id="form-dropzone-1">
                    ...
                    <div class="panel-body">
                        <div id="dropzone">
                            <form action="http://pvradmin.palanivelayudam.net/" class="dropzone needsclick" id="demo-upload">
...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/form_dropzone.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:29:17 GMT -->
</html>