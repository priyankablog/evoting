...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/ui_widget_boxes.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:24:59 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8"/>
    <title>PVR Admin | Widget Boxes</title>
...
<div id="page-container" class="fade page-header-fixed page-sidebar-fixed">
            ...
            <ul class="nav">
                ...
                <li class="has-sub active">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="active"><a href="ui_widget_boxes.html">Widget Boxes</a></li>
    ...
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Widget Boxes
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="panel panel-inverse" data-sortable-id="ui-widget-5">
                    <div class="panel-heading">
                        <h4 class="panel-title"><span class="label label-success m-r-10 pull-left">NEW</span> Panel
                            Header with Label</h4>
                    </div>
                    <div class="panel-body">
                        <p>Panel Content Here</p>
                    </div>
                ...
                <div class="panel panel-inverse" data-sortable-id="ui-widget-6">
                    ...
                    <div class="alert alert-success fade in">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque ac posuere lacus, quis
                            suscipit sem. Nulla sagittis aliquam erat non convallis.</p>
                    </div>
                    <div class="panel-body">
                        <p>Panel Content Here</p>
                    </div>
                    ...
                    <div class="panel-body">
                        <div data-scrollbar="true" data-height="280px">
                            <p>
                                ...
                                interdum nec vitae justo. Quisque ullamcorper vehicula dictum. Nullam hendrerit interdum
                                eleifend.
                                Aenean luctus sed arcu laoreet scelerisque. Vivamus non ullamcorper mauris, id sagittis
                                lorem.
                                Proin tincidunt mauris et dolor mattis imperdiet. Sed facilisis mattis diam elementum
                                adipiscing.
                            </p>
                            <p>
                                ...
                                himenaeos.
                                Ut ante velit, pretium non nisi a, egestas placerat diam. Nullam aliquet iaculis
                                ultricies.
                                Aliquam volutpat, sapien quis volutpat elementum, ligula purus auctor diam, at
                                vestibulum nulla augue
                                vel purus. Praesent ac nisl a magna tincidunt interdum sed in turpis. Maecenas nec
                                condimentum risus.
                            ...
                            <p>
                                ...
                                Etiam sagittis sem tempus purus elementum, vitae pretium sapien porta. Curabitur iaculis
                                ante ut aliquam luctus.
                                Vivamus ullamcorper blandit imperdiet. Ut egestas, orci id rhoncus cursus, orci risus
                                scelerisque enim, eget mattis eros lacus quis ligula.
                            ...
                            <p>
                                ...
                                Morbi accumsan velit dolor. Donec convallis eleifend magna, at euismod tellus convallis
                                a.
                                Curabitur in nisi dolor. Cras viverra scelerisque orci, sed interdum ligula volutpat
                                non.
                ...
                <div class="panel panel-default panel-with-tabs" data-sortable-id="ui-widget-9">
                    <div class="panel-heading">
                        <ul id="myTab" class="nav nav-tabs pull-right">
                            <li class="active"><a href="#home" data-toggle="tab"><i class="fa fa-home"></i> <span
                                    class="hidden-xs">Home</span></a></li>
                            <li><a href="#profile" data-toggle="tab"><i class="fa fa-user"></i> <span class="hidden-xs">Profile</span></a>
                            </li>
                        </ul>
        ...
        <p class="m-b-20">
            You can customize the panel body background by adding predefined background class. E.g
            <code>.bg-black</code>. Full list of available predefined background class can be found <a
                href="helper_css.html">here</a>.
        </p>
        <!-- begin row -->
        <div class="row">
            <!-- begin col-6 -->
