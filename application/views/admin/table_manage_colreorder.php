...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/table_manage_colreorder.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:30:32 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8"/>
    <title>PVR Admin | Managed Tables - ColReorder</title>
...
<div id="page-container" class="fade in page-sidebar-fixed page-header-fixed">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="has-sub active">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="active"><a href="table_manage_colreorder.html">ColReorder</a></li>
    ...
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Managed Tables - ColReorder
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                ...
                <p class="m-b-20">
                    <a href="http://www.datatables.net/extensions/colreorder/" target="_blank"
            ...
            <div class="col-md-10">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="alert alert-success fade in">
                        ...
                        ColReorder adds the ability for the end user to click and drag column headers to reorder a table
                        as they see fit, to DataTables. <br/>
...
<script src="assets/js/table_manage_colreorder_demo.js"></script>
...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/table_manage_colreorder.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:30:36 GMT -->
</html>