...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/page_with_boxed_layout.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:31:59 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8"/>
    <title>PVR Admin | Page with Boxed Layout</title>
...
<div id="page-container" class="page-container fade page-sidebar-fixed page-header-fixed">
            ...
            <ul class="nav">
                ...
                <li class="has-sub active">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="active"><a href="page_with_boxed_layout.html">Page with Boxed Layout</a></li>
    ...
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="active">Page with Boxed Layout</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Page with Boxed Layout
