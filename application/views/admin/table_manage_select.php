...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/table_manage_select.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:30:44 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8"/>
    <title>PVR Admin | Managed Tables - TableTools</title>
...
<div id="page-container" class="fade in page-sidebar-fixed page-header-fixed">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="has-sub active">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="active"><a href="table_manage_select.html">Select</a></li>
    ...
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Managed Tables - Select
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                ...
                <ul class="p-l-25 m-b-15">
                    <li>Operating system (os) style - where a single click will select a single item only, deselecting
                        any others that were previously selected, a shift click will select a range of items and a ctrl
                        / cmd click will add and remove items from the selection.
                    </li>
                    <li>Single item select (single) - only a single item can be selected at any one time. Any previously
                        selected items will be deselected.
                    </li>
                    <li>Multi-item selection (multi) - item selection is toggled with a single click.</li>
                </ul>
                <p class="m-b-20">
                    <a href="http://www.datatables.net/extensions/select/" target="_blank"
                       class="btn btn-inverse btn-sm">View Official Website</a>
                </p>
            </div>
            <!-- end col-2 -->
            <!-- begin col-10 -->
            <div class="col-md-10">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="alert alert-info fade in">
                        ...
                        Select adds item selection capabilities to a DataTable. Items can be rows, columns or cells,
                        which can be selected independently, or together. Item selection can be particularly useful in
                        interactive tables where users can perform some action on the table, such as editing rows or
                        marking items to perform an action on.
                    </div>
...
<script src="assets/js/table_manage_select_demo.js"></script>
...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/table_manage_select.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:30:45 GMT -->
</html>
