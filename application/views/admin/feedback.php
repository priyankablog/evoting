...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8"/>
        <title>My Govrn Admin | Feedback Page</title>
    ...
    <body class="pace-top">
        ...
        <div id="content" class="content" style="margin-top: 60px;">
            ...
            <!-- end breadcrumb -->
            <!-- begin page-header -->
            <h1 class="page-header">Managed Feedback
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Display All Feedback Information</h4>
                        </div>
                        ...
                        <div class="panel-body">
                            <table id="data-table" class="table table-striped table-bordered my-pagging nova-pagging">
                                ...
                                <tbody>
                                  ...
                                  <td><a href="<?php echo base_url();?>Delete/feedback/<?php echo $val->f_id;?>" onclick="return confirm('Are You Sure you want to delete')">Delete</a></td>
                                    </tr>
