...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/table_manage_rowreorder.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:30:41 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8"/>
    <title>PVR Admin | Managed Tables - RowReorder</title>
...
<div id="page-container" class="fade in page-sidebar-fixed page-header-fixed">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="has-sub active">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="active"><a href="table_manage_rowreorder.html">RowReorder</a></li>
    ...
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="active">RowReorder</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Managed Tables - RowReorder
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                ...
                <ul class="p-l-25 m-b-15">
                    ...
                    <li>Drag snapping</li>
                    <li>Full integration with Bootstrap, Foundation and the other styling libraries supported by
                        DataTables
                    </li>
                </ul>
                <p class="m-b-20">
                    <a href="http://www.datatables.net/extensions/rowreorder/" target="_blank"
            ...
            <div class="col-md-10">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="alert alert-warning fade in">
                        ...
                        This trivial example shows the use of the rowReorder property being used to enable RowReorder on
                        a DataTable. The first column in the table is a sequence number that provides the basis for the
                        ordering. To change a row's order, simply click and drag the row.
                    </div>
...
<script src="assets/js/table_manage_rowreorder_demo.js"></script>
...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/table_manage_rowreorder.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:30:42 GMT -->
</html>