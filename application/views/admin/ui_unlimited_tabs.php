...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/ui_unlimited_tabs.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:24:50 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8"/>
    <title>PVR Admin | Unlimited Nav Tabs</title>
...
<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
            ...
            <ul class="nav">
                ...
                <li class="has-sub active">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="active"><a href="ui_unlimited_tabs.html">Unlimited Nav Tabs</a></li>
    ...
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Unlimited Nav Tabs
                    ...
                    <div class="panel-heading p-0">
                        ...
                        <div class="tab-overflow">
                            <ul class="nav nav-tabs nav-tabs-inverse">
                                <li class="prev-button"><a href="javascript:;" data-click="prev-tab"
                                                           class="text-success"><i class="fa fa-arrow-left"></i></a>
                                </li>
                                ...
                                <li class="next-button"><a href="javascript:;" data-click="next-tab"
                                                           class="text-success"><i class="fa fa-arrow-right"></i></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="panel-heading p-0">
                        ...
                        <div class="tab-overflow">
                            <ul class="nav nav-tabs">
                                <li class="prev-button"><a href="javascript:;" data-click="prev-tab"
                                                           class="text-inverse"><i class="fa fa-arrow-left"></i></a>
                                </li>
                                ...
                                <li class="next-button"><a href="javascript:;" data-click="next-tab"
                                                           class="text-inverse"><i class="fa fa-arrow-right"></i></a>
                                </li>
                            </ul>
                        </div>
                    </div>
...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/ui_unlimited_tabs.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:24:51 GMT -->
</html>