...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/table_manage_scroller.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:30:43 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8"/>
    <title>PVR Admin | Managed Tables - Scroller</title>
...
<div id="page-container" class="fade in page-sidebar-fixed page-header-fixed">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="has-sub active">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="active"><a href="table_manage_scroller.html">Scroller</a></li>
    ...
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Managed Tables - Scroller
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                ...
                <p class="m-b-20">
                    <a href="http://www.datatables.net/extensions/scroller/" target="_blank"
            ...
            <div class="col-md-10">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="alert alert-danger fade in">
                        ...
                        Scroller is a virtual rendering plug-in for DataTables which allows large datasets to be drawn
                        on screen every quickly. What the virtual rendering means is that only the visible portion of
                        the table (and a bit to either side to make the scrolling smooth) is drawn, while the scrolling
                        container gives the visual impression that the whole table is visible. This is done by making
                        use of the pagination abilities of DataTables and moving the table around in the scrolling
                        container DataTables adds to the page. The scrolling container is forced to the height it would
                        be for the full table display using an extra element.
                    </div>
                    <div class="panel-body">
                        <table id="data-table" class="table table-striped table-bordered display" cellspacing="0"
                               width="100%">
                            <thead>
                            <tr>
                                <th>ID</th>
...
<script src="assets/js/table_manage_scroller_demo.js"></script>
...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/table_manage_scroller.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:30:44 GMT -->
</html>