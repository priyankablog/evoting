...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/page_with_right_sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:31:58 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8"/>
    <title>PVR Admin | Page with Right Sidebar</title>
...
<div id="page-container" class="fade page-sidebar-fixed page-header-fixed page-with-right-sidebar">
            ...
            <ul class="nav">
                ...
                <li class="has-sub active">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="active"><a href="page_with_right_sidebar.html">Page with Right Sidebar</a></li>
    ...
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Page with Right Sidebar
    ...
    <div id="footer" class="footer fixed">
        &copy; 2017 PVR Admin - Responsive Admin Template - Administrator All Rights Reserved
    </div>
    <!-- end #footer -->
