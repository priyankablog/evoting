...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/page_without_sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:31:58 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8"/>
    <title>PVR Admin | Page without Sidebar</title>
...
<div id="page-container" class="fade page-without-sidebar page-header-fixed">
            ...
            <ul class="nav navbar-nav navbar-right hidden-xs">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu media-list pull-right">
                        ...
                        <li class="media">
                            <a href="javascript:;">
                                <div class="pull-left"><img src="assets/img/user-1.jpg" class="media-object" alt=""/>
                                </div>
                                <div class="media-body">
                        ...
                        <li class="media">
                            <a href="javascript:;">
                                <div class="pull-left"><img src="assets/img/user-2.jpg" class="media-object" alt=""/>
                                </div>
                                <div class="media-body">
    ...
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Page without Sidebar
