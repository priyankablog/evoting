...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/index_v2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:24:27 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8"/>
    <title>PVR Admin | Dashboard v2</title>
...
<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
    ...
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Dashboard v2
                ...
                <div class="widget-chart with-sidebar bg-black">
                    ...
                    <div class="widget-chart-sidebar bg-black-darker">
                        ...
                        <ul class="chart-legend">
                            <li><i class="fa fa-circle-o fa-fw text-success m-r-5"></i> 34.0% <span>New Visitors</span>
                            </li>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="panel panel-inverse" data-sortable-id="index-2">
                    <div class="panel-heading">
                        <h4 class="panel-title">Chat History <span
                                class="label label-success pull-right">4 message</span></h4>
                    </div>
            ...
            <div class="col-md-4">
                ...
                <div class="panel panel-inverse" data-sortable-id="index-4">
                    <div class="panel-heading">
                        <h4 class="panel-title">New Registered Users <span class="pull-right label label-success">24 new users</span>
                        </h4>
                    </div>
            ...
            <div class="col-md-4">
                ...
                <div class="panel panel-inverse" data-sortable-id="index-4">
                    <div class="panel-heading">
                        <h4 class="panel-title">New Users <span
                                class="pull-right label label-success">8 new users</span>
                        </h4>
                    </div>
                    <ul class="registered-users-list clearfix">
                        <li>
...
<script src="assets/js/dashboard_v2_demo.js"></script>
...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/index_v2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:24:31 GMT -->
</html>