...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/form_plugins.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:26:36 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8"/>
    <title>PVR Admin | Form Plugins</title>
    ...
    <link href="assets/plugins/jquery-simplecolorpicker/jquery.simplecolorpicker-fontawesome.css" rel="stylesheet"/>
    <link href="assets/plugins/bootstrap-duallistbox/bootstrap-duallistbox.min.css" rel="stylesheet"/>
...
<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
            ...
            <ul class="nav">
                ...
                <li class="has-sub active">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="active"><a href="form_plugins.html">Form Plugins <span class="label label-theme m-l-5">V 1.2</span></a></li>
    ...
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Form Plugins
            ...
            <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" id="datepicker-default"
                                           placeholder="Select Date" value="04/1/2014"/>
                                </div>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="panel-body panel-form">
                        <form class="form-horizontal form-bordered">
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="" id="jquery-autocomplete" class="form-control"
                ...
                <div class="panel panel-inverse" data-sortable-id="form-plugins-8">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title"><span class="label label-success pull-left m-r-10">NEW</span> Bootstrap
                            Show Password</h4>
                    </div>
                    <div class="panel-body panel-form">
                        <form class="form-horizontal form-bordered">
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input data-toggle="password" data-placement="after" class="form-control"
                                           type="password" value="123" placeholder="password"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4">Show / Hide Password</label>
                                <div class="col-md-8">
                                    <input data-toggle="password" data-placement="before" class="form-control"
                                           type="password" value="123" placeholder="password"/>
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="panel-body panel-form">
                        <form class="form-horizontal form-bordered">
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="password" name="password" id="password-indicator-default"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="password-visible" id="password-indicator-visible"
                                           class="form-control m-b-5"/>
            ...
            <div class="col-md-6">
                        ...
                        <form class="form-horizontal form-bordered">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <input class="form-control" name="color_palatte_custom"
                                                   data-id="color-palette-custom"/>
                                        </div>
                                        <div class="col-md-6">
                ...
                <div class="panel panel-inverse" data-sortable-id="form-plugins-11">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title"><span class="label label-success pull-left m-r-10">NEW</span> jQuery
                            Simple Colorpicker</h4>
                    </div>
                    <div class="panel-body panel-form">
                        <form class="form-horizontal form-bordered">
                            <div class="form-group">
                    ...
                    <div class="panel-body panel-form">
                        <form class="form-horizontal form-bordered">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <div class="input-group colorpicker-component" data-color="rgb(0, 0, 0)"
                                         data-color-format="rgb" id="colorpicker-prepend">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" value="rgb(155,89,182,0.8)"
                                           id="colorpicker-rgba" data-color-format="rgba"/>
                                </div>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="panel-body panel-form">
                        <form class="form-horizontal form-bordered">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" id="customRange_rangeSlider" name="default_rangeSlider"
                                           value=""/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" id="customValue_rangeSlider" name="default_rangeSlider"
                                           value=""/>
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="panel-body panel-form">
                        <form class="form-horizontal form-bordered">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" id="masked-input-tid"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" id="masked-input-pkey"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" id="masked-input-ssn"
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-4">SSN</label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" id="masked-input-pno"
                                           placeholder="AAA-9999-A"/>
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <div class="panel panel-inverse" data-sortable-id="form-plugins-16">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title"><span class="label label-success pull-left m-r-10">NEW</span>
                            Clipboard.js</h4>
                    </div>
                    <div class="panel-body panel-form">
                        <form class="form-horizontal form-bordered">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <textarea class="form-control m-b-10" id="clipboard-textarea" rows="15">Mussum ipsum cacilds...</textarea>
                                    <button class="btn btn-inverse btn-sm" type="button"
                                            data-clipboard-target="#clipboard-textarea" data-clipboard-action="cut">Cut
                                        to clipboard
                                    </button>
                                </div>
                            </div>
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse" data-sortable-id="form-plugins-1">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Bootstrap Dual Listbox <span class="label label-success">V 1.2</span></h4>
                    </div>
...
<script src="assets/plugins/bootstrap-duallistbox/jquery.bootstrap-duallistbox.min.js"></script>
<script src="assets/js/form_plugins_demo.js"></script>
...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/form_plugins.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:27:31 GMT -->
</html>