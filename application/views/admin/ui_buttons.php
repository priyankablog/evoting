...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/ui_buttons.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:25:56 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8"/>
    <title>PVR Admin | Buttons</title>
                ...
                <div class="panel panel-inverse" data-sortable-id="ui-buttons-2">
                    ...
                    <div class="panel-body">
                        <div class="btn-group m-r-5 m-b-5">
                            <a href="javascript:;" data-toggle="dropdown" class="btn btn-default dropdown-toggle">Action
            ...
            <div class="col-md-4">
                <div class="panel panel-inverse" data-sortable-id="ui-buttons-5">
                    ...
                    <div class="panel-body">
                        ...
                        <p>
                            <a href="javascript:;" class="btn btn-success m-r-5"><i class="fa fa-comment"></i>
                                Comment</a>
                        ...
                        <p>
                            <a href="javascript:;" class="btn btn-default btn-block"><i
                                    class="fa fa-list pull-right"></i> Button block with icon</a>
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="panel panel-inverse" data-sortable-id="ui-buttons-7">
                    ...
                    <div class="panel-body">
                        <div class="btn-group-vertical m-r-5">
                            ...
                            <button type="button" class="btn btn-inverse active"><i class="fa fa-cog"></i> Button
                            </button>
                            <button type="button" class="btn btn-inverse"><i class="fa fa-cog"></i> Button</button>
                        </div>
                        <div class="btn-group-vertical m-r-5">
                            <button type="button" class="btn btn-white"><i class="fa fa-file"></i> Button</button>
                            <button type="button" class="btn btn-white active"><i class="fa fa-file"></i> Button
                            </button>
                            <button type="button" class="btn btn-white"><i class="fa fa-file"></i> Button</button>
                        </div>
                        <div class="btn-group-vertical">
                            <button type="button" class="btn btn-success"><i class="fa fa-edit"></i> Button</button>
                            <button type="button" class="btn btn-success active"><i class="fa fa-edit"></i> Button
                            </button>
                            <button type="button" class="btn btn-success"><i class="fa fa-edit"></i> Button</button>
                        </div>
                        <p></p>
                ...
                <div class="panel panel-inverse" data-sortable-id="ui-buttons-8">
                    ...
                    <div class="panel-body">
                        <p>
                            ...
                            <a class="btn btn-inverse btn-icon btn-circle btn-lg"><i
                        ...
                        <p>
                            ...
                            <a class="btn btn-inverse btn-icon btn-circle btn-sm"><i
                                    class="fa fa-stack-overflow"></i></a>
                        </p>
                        <p>
                            ...
                            <a class="btn btn-inverse btn-icon btn-circle btn-xs"><i
                                    class="fa fa-stack-overflow"></i></a>
                        </p>
                    </div>
                </div>
