...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/ui_general.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:24:50 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8"/>
    <title>PVR Admin | General UI Elements</title>
...
<div id="page-container" class="fade page-header-fixed page-sidebar-fixed">
    ...
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">General UI Elements
                    ...
                    <div class="panel-body">
                        <div class="alert alert-info m-b-0">
                            ...
                            <p>
                                ...
                                These features are not supported in Internet Explorer 9 and below or older versions of
                                Firefox. Opera 12 does not support animations.
                            </p>
                        </div>
                        <div class="row">
                            <div class="col-md-3">
