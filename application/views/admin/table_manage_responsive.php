...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/table_manage_responsive.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:30:41 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8"/>
    <title>PVR Admin | Managed Tables - Responsive</title>
...
<div id="page-container" class="fade in page-sidebar-fixed page-header-fixed">
    ...
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Managed Tables - Responsive
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                ...
                <p class="m-b-20">
                    <a href="http://www.datatables.net/extensions/responsive/" target="_blank"
            ...
            <div class="col-md-10">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="alert alert-warning fade in">
                        ...
                        In the modern world of responsive web design tables can often cause a particular problem for
                        designers due to their row based layout. Responsive is an extension for DataTables that resolves
                        that problem by optimising the table's layout for different screen sizes through the dynamic
...
<script src="assets/js/table_manage_responsive_demo.js"></script>
