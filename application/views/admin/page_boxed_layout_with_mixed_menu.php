...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/page_boxed_layout_with_mixed_menu.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:31:59 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8"/>
    <title>PVR Admin | Boxed Layout with Mixed Menu</title>
...
<div id="page-container" class="page-container fade page-sidebar-fixed page-header-fixed page-with-top-menu">
        ...
        <ul class="nav">
            ...
            <li class="has-sub active">
                ...
                <ul class="sub-menu">
                    ...
                    <li class="active"><a href="page_boxed_layout_with_mixed_menu.html">Boxed Layout with Mixed Menu</a>
                    </li>
            ...
            <ul class="nav">
                ...
                <li class="has-sub active">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li><a href="page_with_boxed_layout.html">Page with Boxed Layout</a></li>
                        <li><a href="page_with_mixed_menu.html">Page with Mixed Menu</a></li>
                        <li class="active"><a href="page_boxed_layout_with_mixed_menu.html">Boxed Layout with Mixed
                            Menu</a></li>
                        <li><a href="page_with_transparent_sidebar.html">Page with Transparent Sidebar</a></li>
                    </ul>
                </li>
    ...
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="active">Boxed Layout with Mixed Menu</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Boxed Layout with Mixed Menu
