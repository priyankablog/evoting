...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/email_inbox_v2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:24:32 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8"/>
    <title>PVR Admin | Inbox v2 (10)</title>
            ...
            <ul class="nav">
                ...
                <li class="has-sub active">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="active"><a href="email_inbox_v2.html">Inbox v2</a></li>
            ...
            <div class="vertical-box-column width-250">
                ...
                <div class="wrapper">
                    ...
                    <ul class="nav nav-pills nav-stacked nav-sm">
                        <li class="active"><a href="email_inbox_v2.html"><i class="fa fa-inbox fa-fw m-r-5"></i> Inbox
                    ...
                    <ul class="nav nav-pills nav-stacked nav-sm m-b-0">
                        ...
                        <li><a href="javascript:;"><i class="fa fa-fw m-r-5 fa-circle text-primary"></i> Designer &
                            Employer</a></li>
                        <li><a href="javascript:;"><i class="fa fa-fw m-r-5 fa-circle text-success"></i> Staff</a></li>
                        <li><a href="javascript:;"><i class="fa fa-fw m-r-5 fa-circle text-warning"></i> Sponsorer</a>
                        </li>
                    ...
                    <div class="btn-toolbar">
                        ...
                        <div class="btn-group dropdown">
                            ...
                            <ul class="dropdown-menu text-left text-sm">
                                <li class="active"><a href="#"><i class="fa fa-circle f-s-10 fa-fw m-r-5"></i> All</a>
                                </li>
                                ...
                                <li><a href="javascript:;"><i class="fa f-s-10 fa-fw m-r-5"></i> Everything else</a>
                                </li>
                            </ul>
                        </div>
                        <!-- end btn-group -->
                        <!-- begin btn-group -->
                        <div class="btn-group">
                            <button class="btn btn-sm btn-white" data-toggle="tooltip" data-placement="top"
                        ...
                        <div class="btn-group">
                            <button class="btn btn-sm btn-white hide" data-email-action="delete"><i
                                    class="fa fa-times m-r-3"></i> <span class="hidden-xs">Delete</span></button>
                            <button class="btn btn-sm btn-white hide" data-email-action="archive"><i
                                    class="fa fa-folder m-r-3"></i> <span class="hidden-xs">Archive</span></button>
                            <button class="btn btn-sm btn-white hide" data-email-action="archive"><i
                                    class="fa fa-trash m-r-3"></i> <span class="hidden-xs">Junk</span></button>
                        </div>
                        <!-- end btn-group -->
                    </div>
                    <!-- end btn-toolbar -->
                ...
                <ul class="list-group list-group-lg no-radius list-email">
                    <li class="list-group-item inverse">
                        ...
                        <div class="email-info">
                            ...
                            <p class="email-desc">
                                Praesent id pulvinar orci. Donec ac metus non ligula faucibus venenatis. Suspendisse
                                tortor est, placerat eu dui sed...
                            </p>
                        </div>
                    </li>
                    <li class="list-group-item primary">
                        ...
                        <div class="email-info">
                            ...
                            <h5 class="email-title">
                                <a href="email_detail.html">PVR Admin dashboard v2 is ready for live</a>
                                <span class="label label-primary f-s-10">designer</span>
                            </h5>
                            <p class="email-desc">Proin interdum aliquam urna, quis lobortis magna tincidunt ac. Integer
                                sed pulvinar neque...
                            </p>
                        </div>
                    </li>
                    ...
                    <li class="list-group-item success">
                        ...
                        <div class="email-info">
                            ...
                            <p class="email-desc">
                                Etiam enim ipsum, malesuada in consectetur interdum, malesuada et lacus. Aenean faucibus
                                turpis lorem...
                            </p>
                        </div>
                    </li>
                    <li class="list-group-item inverse">
                        ...
                        <div class="email-info">
                            ...
                            <p class="email-desc">
                                Proin consectetur accumsan rhoncus. Nulla porta orci ultricies lectus consequat
                    ...
                    <li class="list-group-item inverse">
                        ...
                        <div class="email-info">
                            ...
                            <p class="email-desc">
                                Suspendisse ut urna orci. Vivamus ac diam sollicitudin, consequat mauris id, facilisis
                                ipsum. Nam feugiat nisl a justo...
                            </p>
                        </div>
                    </li>
                    ...
                    <li class="list-group-item danger">
                        ...
                        <div class="email-info">
                            ...
                            <h5 class="email-title">
                                <a href="email_detail.html">Simple Line Icons is available onPVR Admin v1.4</a>
                                <span class="label label-danger f-s-10">client</span>
                            </h5>
                            <p class="email-desc">
                                Maecenas auctor dui sit amet tristique congue. Pellentesque lobortis nulla quam. Etiam
                                in vulputate magna...
                            </p>
                        </div>
                    </li>
...
<!-- ================== BEGIN PAGE LEVEL JS ================== -->
<script src="assets/js/email_inbox_v2_demo.js"></script>
...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/email_inbox_v2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:24:33 GMT -->
</html>
