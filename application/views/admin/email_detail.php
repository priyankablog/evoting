...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/email_detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:24:37 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8"/>
    <title>PVR Admin | Detail</title>
            ...
            <ul class="nav">
                ...
                <li class="has-sub active">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li><a href="email_javascript_%3b.html">Inbox v2</a></li>
                        <li><a href="email_compose.html">Compose</a></li>
                        <li class="active"><a href="email_detail.html">Detail</a></li>
                    </ul>
                </li>
                <li class="has-sub">
                    <a href="javascript:;">
            ...
            <div class="vertical-box-column width-250">
                ...
                <div class="wrapper">
                    ...
                    <ul class="nav nav-pills nav-stacked nav-sm">
                        <li class="active"><a href="email_javascript_%3b.html"><i class="fa fa-inbox fa-fw m-r-5"></i> Inbox
                            <span class="badge pull-right">52</span></a></li>
                        <li><a href="email_javascript_%3b.html"><i class="fa fa-flag fa-fw m-r-5"></i> Important</a></li>
                        <li><a href="email_javascript_%3b.html"><i class="fa fa-send fa-fw m-r-5"></i> Sent</a></li>
                        <li><a href="email_javascript_%3b.html"><i class="fa fa-pencil fa-fw m-r-5"></i> Drafts</a></li>
                        <li><a href="email_javascript_%3b.html"><i class="fa fa-trash fa-fw m-r-5"></i> Trash</a></li>
                    </ul>
                    <p><b>LABEL</b></p>
            ...
            <div class="vertical-box-column bg-white">
                ...
                <div class="wrapper bg-silver-lighter clearfix">
                    ...
                    <div class="pull-right">
                        ...
                        <div class="btn-group m-l-5">
                            <a href="javascript:;" class="btn btn-white btn-sm"><i class="fa fa-times"></i></a>
                        </div>
                    </div>
                </div>
                <!-- end wrapper -->
                ...
                <div class="wrapper">
                    ...
                    <ul class="media-list underline m-b-20 p-b-15">
                        <li class="media media-sm clearfix">
                            ...
                            <div class="media-body">
                                    ...
                                    class="fa fa-clock-o fa-fw"></i> 8: 30 AM</span><br/>
                                <span class="email-to">
                    ...
                    <p class="f-s-12 text-inverse">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras vel auctor nisi, vel auctor orci.
                        <br/>
                        Aenean in pretium odio, ut lacinia tellus. Nam sed sem ac enim porttitor vestibulum vitae at
                        erat.
                    </p>
                    <p class="f-s-12 text-inverse">
