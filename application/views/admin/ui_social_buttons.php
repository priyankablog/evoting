...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/ui_social_buttons.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:26:24 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8"/>
    <title>PVR Admin | Social Buttons</title>
...
<div id="page-container" class="fade page-header-fixed page-sidebar-fixed">
            ...
            <ul class="nav">
                ...
                <li class="has-sub active">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="active"><a href="ui_social_buttons.html">Social Buttons</a></li>
    ...
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Social Buttons
        ...
        <div class="row">
                    ...
                    <div class="panel-body p-0">
                        <div class="table-responsive">
                            <table class="table table-striped table-condensed">
                                ...
                                <tr>
                                    <td>
                                        <a class="btn width-250 btn-social btn-adn">
                                ...
                                <tr>
                                    <td>
                                        <a class="btn width-250 btn-social btn-bitbucket">
                                ...
                                <tr>
                                    <td>
                                        <a class="btn width-250 btn-social btn-dropbox">
                                ...
                                <tr>
                                    <td>
                                        <a class="btn width-250 btn-social btn-flickr">
                                ...
                                <tr>
                                    <td>
                                        <a class="btn width-250 btn-social btn-foursquare">
                                ...
                                <tr>
                                    <td>
                                        <a class="btn width-250 btn-social btn-github">
                                ...
                                <tr>
                                    <td>
                                        <a class="btn width-250 btn-social btn-instagram">
                                ...
                                <tr>
                                    <td>
                                        <a class="btn width-250 btn-social btn-linkedin">
                                ...
                                <tr>
                                    <td>
                                        <a class="btn width-250 btn-social btn-microsoft">
                                ...
                                <tr>
                                    <td>
                                        <a class="btn width-250 btn-social btn-odnoklassniki">
                                ...
                                <tr>
                                    <td>
                                        <a class="btn width-250 btn-social btn-openid">
                                ...
                                <tr>
                                    <td>
                                        <a class="btn width-250 btn-social btn-pinterest">
                                ...
                                <tr>
                                    <td>
                                        <a class="btn width-250 btn-social btn-reddit">
                                ...
                                <tr>
                                    <td>
                                        <a class="btn width-250 btn-social btn-soundcloud">
                                ...
                                <tr>
                                    <td>
                                        <a class="btn width-250 btn-social btn-tumblr">
                                ...
                                <tr>
                                    <td>
                                        <a class="btn width-250 btn-social btn-twitter">
                                ...
                                <tr>
                                    <td>
                                        <a class="btn width-250 btn-social btn-vimeo">
                                ...
                                <tr>
                                    <td>
                                        <a class="btn width-250 btn-social btn-vk">
                                ...
                                <tr>
                                    <td>
                                        <a class="btn width-250 btn-social btn-yahoo">
            ...
            <div class="col-md-4">
                <div class="lead">
                    <p>Social Sign-In Buttons made in pure CSS based on Bootstrap and Font Awesome!</p>
                    <a href="https://lipis.github.io/bootstrap-social/" target="_blank" class="btn btn-sm btn-inverse">View
                        Official Website <i class="fa fa-arrow-right m-l-5"></i></a>
                </div>
                <div class="m-b-10"><b>Social Icons</b></div>
                <div class="clearfix m-b-20">
                    <a class="btn btn-social-icon btn-adn pull-left m-r-5 m-b-5"><span class="fa fa-adn"></span></a>
                    <a class="btn btn-social-icon btn-bitbucket pull-left m-r-5 m-b-5"><span
                            class="fa fa-bitbucket"></span></a>
                    <a class="btn btn-social-icon btn-dropbox pull-left m-r-5 m-b-5"><span class="fa fa-dropbox"></span></a>
                    <a class="btn btn-social-icon btn-facebook pull-left m-r-5 m-b-5"><span
                            class="fa fa-facebook"></span></a>
                    <a class="btn btn-social-icon btn-flickr pull-left m-r-5 m-b-5"><span
                            class="fa fa-flickr"></span></a>
                    <a class="btn btn-social-icon btn-foursquare pull-left m-r-5 m-b-5"><span
                            class="fa fa-foursquare"></span></a>
                    <a class="btn btn-social-icon btn-github pull-left m-r-5 m-b-5"><span
                            class="fa fa-github"></span></a>
                    <a class="btn btn-social-icon btn-google pull-left m-r-5 m-b-5"><span
                            class="fa fa-google"></span></a>
                    <a class="btn btn-social-icon btn-instagram pull-left m-r-5 m-b-5"><span
                            class="fa fa-instagram"></span></a>
                    <a class="btn btn-social-icon btn-linkedin pull-left m-r-5 m-b-5"><span
                            class="fa fa-linkedin"></span></a>
                    <a class="btn btn-social-icon btn-microsoft pull-left m-r-5 m-b-5"><span
                            class="fa fa-windows"></span></a>
                    <a class="btn btn-social-icon btn-odnoklassniki pull-left m-r-5 m-b-5"><span
                            class="fa fa-odnoklassniki"></span></a>
                    <a class="btn btn-social-icon btn-openid pull-left m-r-5 m-b-5"><span
                            class="fa fa-openid"></span></a>
                    <a class="btn btn-social-icon btn-pinterest pull-left m-r-5 m-b-5"><span
                            class="fa fa-pinterest"></span></a>
                    <a class="btn btn-social-icon btn-reddit pull-left m-r-5 m-b-5"><span
                            class="fa fa-reddit"></span></a>
                    <a class="btn btn-social-icon btn-soundcloud pull-left m-r-5 m-b-5"><span
                            class="fa fa-soundcloud"></span></a>
                    <a class="btn btn-social-icon btn-tumblr pull-left m-r-5 m-b-5"><span
                            class="fa fa-tumblr"></span></a>
                    <a class="btn btn-social-icon btn-twitter pull-left m-r-5 m-b-5"><span class="fa fa-twitter"></span></a>
                    <a class="btn btn-social-icon btn-vimeo pull-left m-r-5 m-b-5"><span
                            class="fa fa-vimeo-square"></span></a>
                    <a class="btn btn-social-icon btn-vk pull-left m-r-5 m-b-5"><span class="fa fa-vk"></span></a>
                    <a class="btn btn-social-icon btn-yahoo pull-left m-r-5 m-b-5"><span class="fa fa-yahoo"></span></a>
                </div>
                <div class="m-b-10"><b>Different Sizes</b></div>
                <div class="m-b-10">
                    <p>
                        <a class="btn btn-social btn-lg btn-facebook m-r-5"><i class="fa fa-facebook"></i>Sign in with
                            Facebook</a>
                        <a class="btn btn-social-icon btn-lg btn-facebook"><i class="fa fa-facebook"></i></a>
                    </p>
                    <p>
                        <a class="btn btn-social btn-facebook m-r-5"><i class="fa fa-facebook"></i>Sign in with Facebook</a>
                        <a class="btn btn-social-icon btn-facebook"><i class="fa fa-facebook"></i></a>
                    </p>
                    <p>
                        <a class="btn btn-social btn-sm btn-facebook m-r-5"><i class="fa fa-facebook"></i>Sign in with
                            Facebook</a>
                        <a class="btn btn-social-icon btn-sm btn-facebook"><i class="fa fa-facebook"></i></a>
                    </p>
                    <p>
                        <a class="btn btn-social btn-xs btn-facebook m-r-5"><i class="fa fa-facebook"></i>Sign in with
                            Facebook</a>
...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/ui_social_buttons.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:26:25 GMT -->
</html>