...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/table_manage_fixed_header.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:30:38 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8"/>
    <title>PVR Admin | Managed Tables - Fixed Header</title>
...
<div id="page-container" class="fade in page-sidebar-fixed page-header-fixed">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="has-sub active">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="active"><a href="table_manage_fixed_header.html">Fixed Header</a></li>
    ...
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Managed Tables - Fixed Header
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                ...
                <p class="m-b-20">
                    <a href="http://www.datatables.net/extensions/fixedheader/" target="_blank"
            ...
            <div class="col-md-10">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="alert alert-info fade in">
                        ...
                        At times it can be useful to ensure that column titles will remain always visible on a table,
                        even when a user scrolls down a table. The FixedHeader plug-in for DataTables will float the
                        'thead' element above the table at all times to help address this issue. The column titles also
                        remain click-able to perform sorting.
                    </div>
...
<script src="assets/js/table_manage_fixed_header_demo.js"></script>
...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/table_manage_fixed_header.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:30:40 GMT -->
</html>