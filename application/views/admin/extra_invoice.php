...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/extra_invoice.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:32:01 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8"/>
    <title>PVR Admin | Invoice</title>
    ...
    <link href="assets/css/invoice-print.css" rel="stylesheet"/>
...
<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
            ...
            <ul class="nav">
                ...
                <li class="has-sub active">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="active"><a href="extra_invoice.html">Invoice</a></li>
    ...
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header hidden-print">Invoice
                    ...
                    <table class="table table-invoice">
                        ...
                        <tr>
                            <td>
                                ...
                                <small>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed id sagittis arcu.
                                </small>
                            </td>
                            <td>$50.00</td>
                            <td>50</td>
