...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/ui_tour.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:26:25 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8"/>
    <title>PVR Admin | Bootstrap Tour</title>
...
<div id="page-container" class="fade page-header-fixed page-sidebar-fixed">
            ...
            <ul class="nav">
                ...
                <li class="has-sub active">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="active"><a href="ui_tour.html">Intro JS</a></li>
                    </ul>
                </li>
                <li class="has-sub">
                    <a href="javascript:;">
    ...
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="active">Intro JS</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Intro JS
        ...
        <div class="jumbotron text-center bg-white">
            ...
            <p>
                <a class="btn btn-lg btn-primary" href="javascript:void(0);" onclick="javascript:introJs().start();">Demo</a>
            </p>
            <a href="http://introjs.com/" target="_blank" class="text-muted" data-step="5"
        ...
        <div class="row text-center" data-step="3"
            ...
            <!-- begin col-4 -->
            <div class="col-md-4">
                <i class="fa fa-compress fa-5x text-muted"></i>
                <h5 class="m-b-5"><b>No dependencies, fast and small</b></h5>
            ...
            <div class="col-md-4">
                ...
                <h5 class="m-b-5"><b>User-friendly</b></h5>
            ...
            <div class="col-md-4">
                ...
                <h5 class="m-b-5"><b>Browser compatibility</b></h5>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="panel">
                    <div class="panel-body">
                        ...
                        <p>
                            Add progress-bar to your step-by-step introduction. It's as easy as adding <code>.setOption('showProgress',
                            true)</code> option to your Intro.js instance.
                        </p>
                        <a href="javascript:;" class="btn btn-primary btn-sm"
                           onclick="javascript:introJs().setOption('showProgress', true).start();"
                           onclick="javascript:introJs().setOption('showProgress', true).start();">Demo</a>
                    </div>
                </div>
            </div>
            <!-- begin col-4 -->
            <!-- end col-4 -->
            <div class="col-md-4">
                <div class="panel" data-intro="Intro.js has many examples. Browse this section to find out more."
                     data-step="4">
                    <div class="panel-body">
                        <h4><i class="fa fa-commenting-o fa-fw"></i> Hint</h4>
                        <p>
                            Hints enables you to add additional descriptions to any part of a web page. You can define
                            hints by adding <code>data-hint</code> attribute to the HTML elements.
                        </p>
                        <a href="javascript:;" class="btn btn-primary btn-sm"
                           onclick="javascript:introJs().addHints();">Demo</a>
                    </div>
                </div>
            </div>
            <!-- begin col-4 -->
            ...
            <div class="col-md-4">
                <div class="panel">
                    <div class="panel-body">
                        ...
                        <p>
                            You can enable or disable options like buttons, progress-bar and bullets by calling the
                            <code>setOption('showBullets', false)</code> function and pass option name.
                        </p>
                        <a href="javascript:;" class="btn btn-primary btn-sm"
                           onclick="javascript:introJs().setOption('showBullets', false).start();">Demo</a>
                    </div>
                </div>
            </div>
            <!-- end col-4 -->
