...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/register_v3.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:38:53 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8"/>
    <title>PVR Admin | Register Page</title>
    ...
    <div class="register register-with-news-feed">
        ...
        <div class="news-feed">
            ...
            <div class="news-caption">
                <h4 class="caption-title"><i class="fa fa-edit text-success"></i> Announcing the PVR Admin app</h4>
                <p>
                    As a PVR Admin Apps administrator, you use the PVR Admin console to manage your organization’s
        ...
        <div class="right-content">
            ...
            <h1 class="register-header">
                Sign Up
                <small>Create your PVR Admin Account. It’s free and always will be.</small>
            </h1>
            <!-- end register-header -->
            ...
            <div class="register-content">
                <form action="#" method="POST" class="margin-bottom-0">
                    ...
                    <div class="checkbox m-b-30">
                        <label>
                            <input type="checkbox" required/> By clicking Sign Up, you agree to our <a
                                href="#">Terms</a> and that you have read our <a href="#">Data Policy</a>, including our
                            <a href="#">Cookie Use</a>.
                        </label>
                    </div>
...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/register_v3.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:42:10 GMT -->
</html>