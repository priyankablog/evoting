...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/ui_modal_notification.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:24:51 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8"/>
    <title>PVR Admin | Modal & Notification</title>
...
<div id="page-container" class="fade page-header-fixed page-sidebar-fixed">
            ...
            <ul class="nav">
                ...
                <li class="has-sub active">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="active"><a href="ui_modal_notification.html">Modal & Notification <span class="label label-theme m-l-5">V 1.2</span></a></li>
    ...
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Modal & Notification
                    ...
                    <div class="panel-body">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td><a href="javascript:;" id="add-without-image" class="btn btn-sm btn-info">Demo</a>
                                </td>
                            </tr>
                            <tr>
                                <td>Add a white notification</td>
                                <td><a href="javascript:;" id="add-gritter-light"
                                       class="btn btn-sm btn-success">Demo</a></td>
                            </tr>
                            <tr>
                                <td>Add notification (with callbacks)</td>
                                <td><a href="javascript:;" id="add-with-callbacks"
                                       class="btn btn-sm btn-warning">Demo</a></td>
                            </tr>
                            <tr>
                                <td>Add a sticky notification (with callbacks)</td>
                                <td><a href="javascript:;" id="add-sticky-with-callbacks" class="btn btn-sm btn-danger">Demo</a>
                                </td>
                            </tr>
                            <tr>
                    ...
                    <div class="panel-body">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td><a href="#modal-dialog" class="btn btn-sm btn-success" data-toggle="modal">Demo</a>
                                </td>
                            </tr>
                            <tr>
                                <td>Modal Dialog Box with fade out animation.</td>
                                <td><a href="#modal-without-animation" class="btn btn-sm btn-default"
                                       data-toggle="modal">Demo</a></td>
                            </tr>
                            <tr>
                                <td>Modal Dialog Box with full width white background.</td>
                                <td><a href="#modal-message" class="btn btn-sm btn-primary" data-toggle="modal">Demo</a>
                                </td>
                            </tr>
                            <tr>
                                <td>Modal Dialog Box with alert message.</td>
                                <td><a href="#modal-alert" class="btn btn-sm btn-danger" data-toggle="modal">Demo</a>
                                </td>
                            </tr>
                            </tbody>
                        </table>
            ...
            <div class="col-md-12">
                <div class="panel panel-inverse" data-sortable-id="ui-modal-notification-1">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Toastr <span class="label label-theme m-l-5">V 1.2</span></h4>
                    </div>
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="form-group" id="positionGroup">
                                    ...
                                    <div class="radio">
                                        <label>
                                            <input type="radio" name="positions" value="toast-top-right" checked="">Top
                                            Right
                                        </label>
                                    </div>
                                    <div class="radio">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="extendedTimeOut" type="text" placeholder="ms" class="form-control"
                                           value="1000">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <button type="button" class="btn btn-white" id="clearlasttoast">Clear Last Toast
                                </button>
...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/ui_modal_notification.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:24:59 GMT -->
</html>