...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/form_summernote.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:29:13 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8"/>
    <title>PVR Admin | Summernote</title>
...
<div id="page-container" class="fade page-header-fixed page-sidebar-fixed">
            ...
            <ul class="nav">
                ...
                <li class="has-sub active">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="active"><a href="form_summernote.html">Summernote</a></li>
    ...
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Summernote
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                ...
                <p>
                    <a href="http://summernote.org/" target="_blank" class="btn btn-sm btn-inverse">View Official
                        Website</a>
                </p>
            </div>
            <!-- end col-2 -->
...
<script src="assets/js/form_summernote_demo.js"></script>
...
<!-- Mirrored from pvradmin.palanivelayudam.net/pvradmin/form_summernote.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2017 09:29:16 GMT -->
</html>