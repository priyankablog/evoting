                    ...
                    if ($q1[0]->status == 1) {
                                    ...
                                    foreach ($q as $query) {
                                        ...
                                        <div class="box col-md-4 col-sm-4 col-xs-12" style="padding-top:30px;">
                                            <div class="inner-box wow fadeInLeft mybox animated" data-wow-delay="0ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 0ms; animation-name: fadeInLeft; border:1px solid #dfdfdf;padding: 20px;height:550px;background-color: #ffffff;width:270px;">
                                                    ...
                                                    <div class="upper-box">
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <a class="btn btn-primary" style="background-color: #00b7f1;
                                                               border-color: #00b7f1;" href="<?php echo base_url(); ?>Edit-Candidate/<?php echo $query->candidate_id; ?>">Edit</a>
                                                        ...
                                                        <div class="col-md-12" style="margin-top: 5px;">
                                                            ...
                                                            if ($query->status == 0) {
                                                                ...
                                                                <a class="btn btn-danger unbl" style="width: 77%;" id="<?php echo $query->candidate_id; ?>" onclick="ublock(this.id, 'candidateblock');">Unblock Candidate</a>

                                                                <?php
                                                            } else {
                                                                ?>

                                                                <a class="btn btn-danger bl" style="width: 77%;" id="<?php echo $query->candidate_id; ?>" onclick="ublock(this.id, 'candidateblock');">Block Candidate</a>
