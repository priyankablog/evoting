        ...
        <div class="services-section style-two">
            <div class="container">
                <div class="sec-title" style="margin-top: -70px;">
                    ...
                    <h3 style="line-height: 2.6em;">All Block <span class="theme_color">Candidate</span></h3>
                ...
                <div class="row">
                    ...
                    <div class="right-side-bar">
                        <div class="auto-container">
                            <div class="row">
                                <div class="col-md-12" id="unblockcandidate">
                                    <!--News Block-->
                                    <?php
                    ...
                    if ($q1[0]->status == 1) {
                                 ...
                                 if(!empty($q))
                                 {
                                                ...
                                                <div class="lower-content" style="border:none">
                                                    <div class="upper-box">
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <a class="btn btn-primary" target="_blank" style="background-color: #00b7f1;
                                    ...
                                    ?>
                                    <div class="text">
                                        <p style="color:#555;">No Block Candidate Available</p>
                                    </div>
                                    <?php
                                    }
                                    }
                                    ...
                                    ?>
                                    <div class="text">
                                        <p style="color:#555;">Candidate Not Available</p>
                                    </div>
                                    <?php
                                    }
                    }
