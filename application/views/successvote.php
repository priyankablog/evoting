                        ...
                        <div class="col-md-10  col-md-offset-1 col-sm-12 col-xs-12 contact-form default-form" style="padding: 20px;background: #f9f9f9;height: 350px;background-color: white;">
                            <center>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <p style="font-size: 20px; color: black;padding-top: 20px;">Yeah, your vote casted successfully.</p>
                                </div>
                                <div class="col-md-12">

                                    <p style="font-size: 14px;padding-top: 10px;" class="text-warning">You will be notify by email who is win or lose in these election!</p>
                                </div>
                                <div class="col-md-12" style="padding-top: 20px;">

       <!--<a href="<?php echo base_url(); ?>Party-Dashboard" class="theme-btn btn-style-one" id="more" name="submit" >Go To Profile</a>-->
                                    <input type="submit" class="theme-btn btn-style-one" id="more" name="submit" value="Go To Your Profile Page"/>
