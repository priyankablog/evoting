                    ...
                    ?>    
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-4" id="mycss1" style="padding: 40px;background: #fff;box-shadow: 0 0 0 2px #eee,0 0 0 7px #fff,0 0 0 9px #eee; height: 72%;margin-left: 26px;margin-top: 28px;width:398px;">
                                    <div class="row">
                                        <div class="">
                                            ...
                                            <div class="default-form-area" id="css1">
                                                <form name="idproof_form" class="default-form" method="post" enctype="multipart/form-data">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="group-inner">
                                                            <label id="new" class="">Select Logo</label>
                                                           
                                                            <input class="form-control  <?php
                                                            if (isset($error1)) {
                                                                echo "error_style";
                                                            }
                                                            ?>" onchange="readURL(this);" name="logo" id="blah" type="file" multiple=""> 
                                                            <p class="err_msg"> <?php
                                                                if (isset($error1)) {
                                                                    echo $error1;
                                                                }
